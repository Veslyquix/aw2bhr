 ...
 * contiguous block at 0x0803B15C.
 * sub_0803B15C @ 0x0803B15C, sub_0803B16C @ 0x0803B16C
 */
 ...
 * symbol through sub_08015BD0 rather than sub_080152EC, which is the same
...
{
    return sub_08015BD0((s32)gUnknown_0849E670) != -1;
}
