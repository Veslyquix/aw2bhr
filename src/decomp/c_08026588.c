...
{
    gUnknown_08499598[a].destroyedThisTurn++;

    if (gUnknown_08499598[a].destroyedThisTurn > gUnknown_08499598[a].totalDestroyed)
        gUnknown_08499598[a].totalDestroyed = gUnknown_08499598[a].destroyedThisTurn;
}
