...
int sub_08010B34(int x, int y)
{
    ...
    {
        u = ((struct Map *)gUnknown_08499590)->tile[
                ((struct Map *)gUnknown_08499590)->rowOffset[y] + x];
        if (u == 0x162 || u == 0x163)
        {
            if (sub_0800F8D4(x, y))
...
int sub_08010DD4(int x, int y)
{
    ...
    if (t == 0x142)
    {
        ...
        {
            u = ((struct Map *)gUnknown_08499590)->tile[
                    ((struct Map *)gUnknown_08499590)->rowOffset[y] + (x - 1)];
            if (u == 0x162 || u == 0x163)
                return 1;
        }
        if (x + 1 >= ((struct Map *)gUnknown_08499590)->width)
            return 0;
        u = ((struct Map *)gUnknown_08499590)->tile[
                ((struct Map *)gUnknown_08499590)->rowOffset[y] + (x + 1)];
        if (u == 0x162 || u == 0x163)
    ...
    else if (t == 0x143)
    {
        ...
        if (y + 1 >= ((struct Map *)gUnknown_08499590)->height)
            return 0;
        u = ((struct Map *)gUnknown_08499590)->tile[
                ((struct Map *)gUnknown_08499590)->rowOffset[y + 1] + x];
        if (u == 0x162 || u == 0x163)
