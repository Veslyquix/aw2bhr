 ...
 * GetSpeedScore @ 0x080263A4
 */

/* A percentage ramp: below the chapter's threshold the answer is a flat 100,
 * above four times it zero, and in between it falls linearly. IsHardCampaignMode
 ...
 * than reusing the first, because the call to IsHardCampaignMode sits between them.
 *
 ...
 * old GetSpeedScore symbol is kept as a linker alias below so every other
