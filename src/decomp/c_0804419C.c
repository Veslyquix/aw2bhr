...
{
    return GetCoPowerStarCost(a1) * gUnknown_085D3DD0[gPlayers[a1].co].coPowerStars;
}
...
{
    return GetCoPowerStarCost(a1) * gUnknown_085D3DD0[gPlayers[a1].co].superCoPowerStars;
}
