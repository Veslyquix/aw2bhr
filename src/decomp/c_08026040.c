 ...
 *
 * The copy loop is a STRUCT ASSIGNMENT of the 0x0c-byte struct Unk08499594,
 ...
 * sub_080260D0's promoted definition, which takes `struct Unk08499594 *`.
 *
