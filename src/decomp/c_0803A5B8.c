...
void sub_0803A5B8(void)
{
    ...
    {
    case 4:
        c = sub_08014CEC(gTextTable[gUnknown_085D5ABC[gUnknown_0849D89C->unk04->unk00].unk02]);
        break;
    case 0xb:
        c = sub_08014CEC(gTextTable[gUnknown_085D5ABC[gUnknown_0849D89C->unk04->unk00].unk04]);
        break;
    }
