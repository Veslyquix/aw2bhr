...
{
    gPlayers[a1].coActivationMode = a2;

    gUnknown_085D3DD0[gPlayers[a1].co]
        .power[gPlayers[a1].coActivationMode].powerAssembly(a3);

    gUnknown_084A0090[gPlayers[gUnknown_030033EC].co]
        .power[gPlayers[gUnknown_030033EC].coActivationMode - 1].onActivate(0);
}

asm(".global sub_08044B28\n.thumb_set sub_08044B28, ActivateCoPower\n");
