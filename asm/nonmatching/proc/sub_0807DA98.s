...
_0807E4C6:
	...
	asrs r0, r0, #0x10
	mov sl, r0
	ldr r0, _0807E51C @ =gUnknown_0808F100
	movs r3, #0
	ldrsh r4, [r0, r3]
	rsbs r0, r4, #0
	lsls r0, r0, #4
	...
	b _0807E522
	.align 2, 0
_0807E51C: .4byte gUnknown_0808F100
_0807E520:
	movs r1, #2
_0807E522:
	adds r0, r4, #0
	...
	lsls r4, r4, #0x10
	asrs r4, r4, #0x10
	ldr r0, _0807E578 @ =gUnknown_0808F100
	adds r0, #0x80
	movs r1, #0
	ldrsh r0, [r0, r1]
	lsls r0, r0, #4
	...
	b _0807E59A
	.align 2, 0
_0807E578: .4byte gUnknown_0808F100
_0807E57C:
	lsls r1, r6, #4
	adds r1, #0x68
	lsls r2, r6, #1
...
_0807E622:
	...
	asrs r0, r0, #0x10
	mov sl, r0
	ldr r0, _0807E678 @ =gUnknown_0808F100
	movs r3, #0
	ldrsh r4, [r0, r3]
	rsbs r0, r4, #0
	lsls r0, r0, #4
	...
	b _0807E67E
	.align 2, 0
_0807E678: .4byte gUnknown_0808F100
_0807E67C:
	movs r1, #2
_0807E67E:
	adds r0, r4, #0
	...
	lsls r4, r4, #0x10
	asrs r4, r4, #0x10
	ldr r0, _0807E754 @ =gUnknown_0808F100
	adds r0, #0x80
	movs r1, #0
	ldrsh r0, [r0, r1]
	lsls r0, r0, #4
...
_0807E72E:
	...
	b _0807E78C
	.align 2, 0
_0807E754: .4byte gUnknown_0808F100
...
_0807E802:
	...
	asrs r0, r0, #0x10
	mov sl, r0
	ldr r0, _0807E850 @ =gUnknown_0808F100
	movs r3, #0
	ldrsh r0, [r0, r3]
	rsbs r0, r0, #0
	lsls r7, r0, #4
	...
	b _0807E856
	.align 2, 0
_0807E850: .4byte gUnknown_0808F100
_0807E854:
	movs r1, #2
_0807E856:
	adds r0, r7, #0
	...
	asrs r0, r0, #0x10
	mov sb, r0
	ldr r0, _0807E8A0 @ =gUnknown_0808F100
	movs r1, #0
	ldrsh r0, [r0, r1]
	lsls r7, r0, #4
	movs r5, #0x80
	...
	b _0807E8A6
	.align 2, 0
_0807E8A0: .4byte gUnknown_0808F100
_0807E8A4:
	movs r1, #2
_0807E8A6:
	adds r0, r7, #0
	...
	asrs r0, r0, #0x10
	mov r8, r0
	ldr r0, _0807E8F4 @ =gUnknown_0808F100
	adds r0, #0x80
	movs r3, #0
	ldrsh r0, [r0, r3]
	lsls r4, r0, #4
	...
	b _0807E8FA
	.align 2, 0
_0807E8F4: .4byte gUnknown_0808F100
_0807E8F8:
	movs r1, #2
_0807E8FA:
	adds r0, r4, #0
