...
_08049470:
	cmp r7, #1
	bne _0804949C
	ldr r2, _08049494 @ =gUnknown_030030CC
	ldrb r1, [r2, #1]
	movs r0, #0x21
	rsbs r0, r0, #0
	ands r0, r1
...
_08049494: .4byte gUnknown_030030CC
...
_0804950C:
	ldr r0, _08049520 @ =gUnknown_03002EE0
	ldr r0, [r0]
	ldrh r1, [r0, #0xc]
	movs r0, #2
	ands r0, r1
	...
	b _08049808
	.align 2, 0
_08049520: .4byte gUnknown_03002EE0
_08049524:
	bl sub_08019260
	lsls r0, r0, #0x18
	lsrs r1, r0, #0x18
...
_080497EC:
	ldr r0, _08049818 @ =gUnknown_03002EE0
	ldr r0, [r0]
	ldrh r1, [r0, #0xc]
	movs r0, #2
	ands r0, r1
...
_08049808:
	...
	b _080498F0
	.align 2, 0
_08049818: .4byte gUnknown_03002EE0
