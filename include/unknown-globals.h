 ...
 * -- six s16 y-offsets (-0x80, -0x28, -0x08, 0x10, -0x08, -0x28), which
 * sub_080829B0 names separately as gUnknown_08616972 -- so the boundary is a
 * type change, not an inference from the index.
