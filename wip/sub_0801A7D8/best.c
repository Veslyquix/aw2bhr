 ...
 *   - `gUnknown_0200CC88[16 + x]` is WRONG and `gUnknown_0200CC88.slotGeneration[x]` is
...
int sub_0801A7D8(u8 a1, void *a2, int a3)
{
    ...
    for (j = 0; j < n - 1; j++)
    {
        for (k = j + 1; k < n; k++)
        {
            if (gUnknown_0200CC88.slotGeneration[list[j]] < gUnknown_0200CC88.slotGeneration[list[k]])
            {
                u8 t;
    ...
    for (;;)
    {
        ...
        for (idx = nc - 1; idx >= 0; )
        {
            ...
            if (gUnknown_0200CC88.slotGeneration[cur] != -1)
                gUnknown_0200CC88.slotGeneration[cur]++;
            ...
            *(u16 *)(gUnknown_02002000 + 0xe) = offs[idx];
            ...
            for (i = 0; i < 16; i++)
                ((u32 *)(gUnknown_02002000 + 0x10))[i] = gUnknown_0200CC88.slotGeneration[i];
            ...
            *(u16 *)(gUnknown_02002000 + 0x50) = lens[idx];
            ...
            if (sub_0801B648(cur, (int)gUnknown_02002000) == 0)
            {
                ...
                gUnknown_0200CC88.slotGeneration[cur] = *(u32 *)(gUnknown_02002000 + 8);
                retry = 0;
                flags[cur] = 1;
                idx--;
            }
