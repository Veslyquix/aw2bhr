...
void sub_08046030(void)
{
    ...
    {
        u8 *data = sub_080248E4();
        register u16 **tilesA asm("r4") = &gUnknown_08499578;
        register int palA asm("r6") = 0x8000;
        register int zeroA asm("r5") = 0;
        sub_080149C0(3, 2, *tilesA, data, palA, zeroA);
        sub_08014B0C(0x1c, 2, *tilesA, gUnknown_03004080, palA, zeroA);
    }
