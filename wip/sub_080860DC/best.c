...
void sub_080860DC(ProcPtr procp)
{
    ...
    if (gpKeySt->repeated & 0x80)
  {
    ...
    *((u16 *) (&p->unk4e)) = 1;
    ...
    if (((gpKeySt->pressed & 1) && (p->unk4e == 0)) && (Proc_Find(gUnknown_084892C4) == 0))
  {
    ...
    if (((gpKeySt->pressed & 2) && (Proc_Find(gUnknown_084892C4) == 0)) && (Proc_Find(gUnknown_08616CCC) == 0))
  {
    sub_0803B4DC(0x66);
    sub_0803BD60();
    sub_08037780();
